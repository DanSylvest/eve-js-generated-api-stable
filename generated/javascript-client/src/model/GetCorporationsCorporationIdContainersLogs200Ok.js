...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('container_id'))
        obj.containerId = ApiClient.convertToType(data['container_id'], 'Number');
      if (data.hasOwnProperty('container_type_id'))
        obj.containerTypeId = ApiClient.convertToType(data['container_type_id'], 'Number');
      ...
      if (data.hasOwnProperty('logged_at'))
        obj.loggedAt = ApiClient.convertToType(data['logged_at'], 'Date');
      if (data.hasOwnProperty('new_config_bitmask'))
        obj.newConfigBitmask = ApiClient.convertToType(data['new_config_bitmask'], 'Number');
      if (data.hasOwnProperty('old_config_bitmask'))
        obj.oldConfigBitmask = ApiClient.convertToType(data['old_config_bitmask'], 'Number');
      if (data.hasOwnProperty('password_type'))
        obj.passwordType = ApiClient.convertToType(data['password_type'], 'String');
   ...
   * @member {Number} containerTypeId
   */
  exports.prototype.containerTypeId = undefined;

  /**
   * location_flag string
   * @member {module:model/GetCorporationsCorporationIdContainersLogs200Ok.LocationFlagEnum} locationFlag
   */
   ...
   */
  exports.prototype.loggedAt = undefined;

  /**
   * new_config_bitmask integer
   * @member {Number} newConfigBitmask
   */
  exports.prototype.newConfigBitmask = undefined;

  /**
   * old_config_bitmask integer
   * @member {Number} oldConfigBitmask
   */
  exports.prototype.oldConfigBitmask = undefined;

  /**
   * Type of password set if action is of type SetPassword or EnterPassword
   * @member {module:model/GetCorporationsCorporationIdContainersLogs200Ok.PasswordTypeEnum} passwordType
   */
  exports.prototype.passwordType = undefined;
  ...
  /**
   * Allowed values for the <code>passwordType</code> property.
   * @enum {String}
   * @readonly
   */
