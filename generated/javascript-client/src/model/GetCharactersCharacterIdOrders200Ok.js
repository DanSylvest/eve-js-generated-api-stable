...
(function(root, factory) {
   ...
   */
  var exports = function(duration, isCorporation, issued, locationId, orderId, price, range, regionId, typeId, volumeRemain, volumeTotal) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('is_corporation'))
        obj.isCorporation = ApiClient.convertToType(data['is_corporation'], 'Boolean');
   ...
   * @member {Boolean} isCorporation
   */
  exports.prototype.isCorporation = undefined;
