...
(function(root, factory) {
   ...
   */
  var exports = function(clientId, _date, isBuy, isPersonal, journalRefId, locationId, quantity, transactionId, typeId, unitPrice) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('is_personal'))
        obj.isPersonal = ApiClient.convertToType(data['is_personal'], 'Boolean');
   ...
   */
  exports.prototype.isPersonal = undefined;
