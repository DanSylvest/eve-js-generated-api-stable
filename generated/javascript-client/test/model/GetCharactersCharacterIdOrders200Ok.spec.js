...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetCharactersCharacterIdOrders200Ok', function() {
      beforeEach(function() {
        instance = new EveSwaggerInterface.GetCharactersCharacterIdOrders200Ok();
      });

      it('should create an instance of GetCharactersCharacterIdOrders200Ok', function() {
        // TODO: update the code to test GetCharactersCharacterIdOrders200Ok
        expect(instance).to.be.a(EveSwaggerInterface.GetCharactersCharacterIdOrders200Ok);
      });
