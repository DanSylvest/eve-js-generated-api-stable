...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetCorporationsCorporationIdFwStatsVictoryPoints', function() {
      beforeEach(function() {
        instance = new EveSwaggerInterface.GetCorporationsCorporationIdFwStatsVictoryPoints();
      });

      it('should create an instance of GetCorporationsCorporationIdFwStatsVictoryPoints', function() {
        // TODO: update the code to test GetCorporationsCorporationIdFwStatsVictoryPoints
        expect(instance).to.be.a(EveSwaggerInterface.GetCorporationsCorporationIdFwStatsVictoryPoints);
      });
