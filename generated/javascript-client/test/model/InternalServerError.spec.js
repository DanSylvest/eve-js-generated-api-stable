...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InternalServerError', function() {
      beforeEach(function() {
        instance = new EveSwaggerInterface.InternalServerError();
      });

      it('should create an instance of InternalServerError', function() {
        // TODO: update the code to test InternalServerError
        expect(instance).to.be.a(EveSwaggerInterface.InternalServerError);
      });
