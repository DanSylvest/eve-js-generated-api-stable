...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetUniversePlanetsPlanetIdOk', function() {
      beforeEach(function() {
        instance = new EveSwaggerInterface.GetUniversePlanetsPlanetIdOk();
      });

      it('should create an instance of GetUniversePlanetsPlanetIdOk', function() {
        // TODO: update the code to test GetUniversePlanetsPlanetIdOk
        expect(instance).to.be.a(EveSwaggerInterface.GetUniversePlanetsPlanetIdOk);
      });
