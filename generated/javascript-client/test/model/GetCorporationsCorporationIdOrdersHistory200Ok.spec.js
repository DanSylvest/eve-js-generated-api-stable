  ...
  describe('(package)', function() {
    describe('GetCorporationsCorporationIdOrdersHistory200Ok', function() {
      ...
      it('should create an instance of GetCorporationsCorporationIdOrdersHistory200Ok', function() {
        // TODO: update the code to test GetCorporationsCorporationIdOrdersHistory200Ok
      ...
      it('should have the property walletDivision (base name: "wallet_division")', function() {
        // TODO: update the code to test the property walletDivision
        expect(instance).to.have.property('walletDivision');
        // expect(instance.walletDivision).to.be(expectedValueLiteral);
      });
