...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GatewayTimeout', function() {
      beforeEach(function() {
        instance = new EveSwaggerInterface.GatewayTimeout();
      });

      it('should create an instance of GatewayTimeout', function() {
        // TODO: update the code to test GatewayTimeout
        expect(instance).to.be.a(EveSwaggerInterface.GatewayTimeout);
      });
