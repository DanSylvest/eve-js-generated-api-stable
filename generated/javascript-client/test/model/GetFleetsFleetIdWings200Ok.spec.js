  ...
  describe('(package)', function() {
    describe('GetFleetsFleetIdWings200Ok', function() {
      ...
      it('should create an instance of GetFleetsFleetIdWings200Ok', function() {
        // TODO: update the code to test GetFleetsFleetIdWings200Ok
      ...
      it('should have the property squads (base name: "squads")', function() {
        // TODO: update the code to test the property squads
        expect(instance).to.have.property('squads');
        // expect(instance.squads).to.be(expectedValueLiteral);
      });
