...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostCorporationsCorporationIdAssetsLocationsPosition', function() {
      beforeEach(function() {
        instance = new EveSwaggerInterface.PostCorporationsCorporationIdAssetsLocationsPosition();
      });

      it('should create an instance of PostCorporationsCorporationIdAssetsLocationsPosition', function() {
        // TODO: update the code to test PostCorporationsCorporationIdAssetsLocationsPosition
        expect(instance).to.be.a(EveSwaggerInterface.PostCorporationsCorporationIdAssetsLocationsPosition);
      });
