...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetUniverseSystemsSystemIdPosition', function() {
      beforeEach(function() {
        instance = new EveSwaggerInterface.GetUniverseSystemsSystemIdPosition();
      });

      it('should create an instance of GetUniverseSystemsSystemIdPosition', function() {
        // TODO: update the code to test GetUniverseSystemsSystemIdPosition
        expect(instance).to.be.a(EveSwaggerInterface.GetUniverseSystemsSystemIdPosition);
      });
