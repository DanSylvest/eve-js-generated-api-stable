...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetUniverseAsteroidBeltsAsteroidBeltIdPosition', function() {
      beforeEach(function() {
        instance = new EveSwaggerInterface.GetUniverseAsteroidBeltsAsteroidBeltIdPosition();
      });

      it('should create an instance of GetUniverseAsteroidBeltsAsteroidBeltIdPosition', function() {
        // TODO: update the code to test GetUniverseAsteroidBeltsAsteroidBeltIdPosition
        expect(instance).to.be.a(EveSwaggerInterface.GetUniverseAsteroidBeltsAsteroidBeltIdPosition);
      });
