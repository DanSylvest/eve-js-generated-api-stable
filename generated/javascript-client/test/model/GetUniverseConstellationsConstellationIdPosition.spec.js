...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetUniverseConstellationsConstellationIdPosition', function() {
      beforeEach(function() {
        instance = new EveSwaggerInterface.GetUniverseConstellationsConstellationIdPosition();
      });

      it('should create an instance of GetUniverseConstellationsConstellationIdPosition', function() {
        // TODO: update the code to test GetUniverseConstellationsConstellationIdPosition
        expect(instance).to.be.a(EveSwaggerInterface.GetUniverseConstellationsConstellationIdPosition);
      });
