...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetCorporationsCorporationIdContacts200Ok', function() {
      beforeEach(function() {
        instance = new EveSwaggerInterface.GetCorporationsCorporationIdContacts200Ok();
      });

      it('should create an instance of GetCorporationsCorporationIdContacts200Ok', function() {
        // TODO: update the code to test GetCorporationsCorporationIdContacts200Ok
        expect(instance).to.be.a(EveSwaggerInterface.GetCorporationsCorporationIdContacts200Ok);
      });
