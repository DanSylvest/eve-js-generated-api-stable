...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetFwLeaderboardsCharactersKills', function() {
      beforeEach(function() {
        instance = new EveSwaggerInterface.GetFwLeaderboardsCharactersKills();
      });

      it('should create an instance of GetFwLeaderboardsCharactersKills', function() {
        // TODO: update the code to test GetFwLeaderboardsCharactersKills
        expect(instance).to.be.a(EveSwaggerInterface.GetFwLeaderboardsCharactersKills);
      });
