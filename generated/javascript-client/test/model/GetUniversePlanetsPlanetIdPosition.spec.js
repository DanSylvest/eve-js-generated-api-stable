...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetUniversePlanetsPlanetIdPosition', function() {
      beforeEach(function() {
        instance = new EveSwaggerInterface.GetUniversePlanetsPlanetIdPosition();
      });

      it('should create an instance of GetUniversePlanetsPlanetIdPosition', function() {
        // TODO: update the code to test GetUniversePlanetsPlanetIdPosition
        expect(instance).to.be.a(EveSwaggerInterface.GetUniversePlanetsPlanetIdPosition);
      });
