...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetCharactersCharacterIdAssets200Ok', function() {
      beforeEach(function() {
        instance = new EveSwaggerInterface.GetCharactersCharacterIdAssets200Ok();
      });

      it('should create an instance of GetCharactersCharacterIdAssets200Ok', function() {
        // TODO: update the code to test GetCharactersCharacterIdAssets200Ok
        expect(instance).to.be.a(EveSwaggerInterface.GetCharactersCharacterIdAssets200Ok);
      });
