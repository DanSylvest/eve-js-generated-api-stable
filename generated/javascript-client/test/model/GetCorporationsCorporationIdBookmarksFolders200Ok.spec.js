...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetCorporationsCorporationIdBookmarksFolders200Ok', function() {
      beforeEach(function() {
        instance = new EveSwaggerInterface.GetCorporationsCorporationIdBookmarksFolders200Ok();
      });
      ...
      it('should create an instance of GetCorporationsCorporationIdBookmarksFolders200Ok', function() {
        ...
        expect(instance).to.be.a(EveSwaggerInterface.GetCorporationsCorporationIdBookmarksFolders200Ok);
      });
