...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetFwLeaderboardsCorporationsVictoryPoints', function() {
      beforeEach(function() {
        instance = new EveSwaggerInterface.GetFwLeaderboardsCorporationsVictoryPoints();
      });

      it('should create an instance of GetFwLeaderboardsCorporationsVictoryPoints', function() {
        // TODO: update the code to test GetFwLeaderboardsCorporationsVictoryPoints
        expect(instance).to.be.a(EveSwaggerInterface.GetFwLeaderboardsCorporationsVictoryPoints);
      });
