...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetUniverseMoonsMoonIdPosition', function() {
      beforeEach(function() {
        instance = new EveSwaggerInterface.GetUniverseMoonsMoonIdPosition();
      });

      it('should create an instance of GetUniverseMoonsMoonIdPosition', function() {
        // TODO: update the code to test GetUniverseMoonsMoonIdPosition
        expect(instance).to.be.a(EveSwaggerInterface.GetUniverseMoonsMoonIdPosition);
      });
