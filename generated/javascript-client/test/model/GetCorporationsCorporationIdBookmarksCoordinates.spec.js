...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetCorporationsCorporationIdBookmarksCoordinates', function() {
      beforeEach(function() {
        instance = new EveSwaggerInterface.GetCorporationsCorporationIdBookmarksCoordinates();
      });

      it('should create an instance of GetCorporationsCorporationIdBookmarksCoordinates', function() {
        // TODO: update the code to test GetCorporationsCorporationIdBookmarksCoordinates
        expect(instance).to.be.a(EveSwaggerInterface.GetCorporationsCorporationIdBookmarksCoordinates);
      });
