...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetCharactersCharacterIdFwStatsKills', function() {
      beforeEach(function() {
        instance = new EveSwaggerInterface.GetCharactersCharacterIdFwStatsKills();
      });

      it('should create an instance of GetCharactersCharacterIdFwStatsKills', function() {
        // TODO: update the code to test GetCharactersCharacterIdFwStatsKills
        expect(instance).to.be.a(EveSwaggerInterface.GetCharactersCharacterIdFwStatsKills);
      });
