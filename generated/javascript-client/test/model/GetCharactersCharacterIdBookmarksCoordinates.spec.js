...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetCharactersCharacterIdBookmarksCoordinates', function() {
      beforeEach(function() {
        instance = new EveSwaggerInterface.GetCharactersCharacterIdBookmarksCoordinates();
      });

      it('should create an instance of GetCharactersCharacterIdBookmarksCoordinates', function() {
        // TODO: update the code to test GetCharactersCharacterIdBookmarksCoordinates
        expect(instance).to.be.a(EveSwaggerInterface.GetCharactersCharacterIdBookmarksCoordinates);
      });
