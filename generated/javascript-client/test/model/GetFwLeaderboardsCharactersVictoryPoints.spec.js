...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetFwLeaderboardsCharactersVictoryPoints', function() {
      beforeEach(function() {
        instance = new EveSwaggerInterface.GetFwLeaderboardsCharactersVictoryPoints();
      });

      it('should create an instance of GetFwLeaderboardsCharactersVictoryPoints', function() {
        // TODO: update the code to test GetFwLeaderboardsCharactersVictoryPoints
        expect(instance).to.be.a(EveSwaggerInterface.GetFwLeaderboardsCharactersVictoryPoints);
      });
