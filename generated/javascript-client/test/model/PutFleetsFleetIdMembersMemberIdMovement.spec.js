...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PutFleetsFleetIdMembersMemberIdMovement', function() {
      beforeEach(function() {
        instance = new EveSwaggerInterface.PutFleetsFleetIdMembersMemberIdMovement();
      });

      it('should create an instance of PutFleetsFleetIdMembersMemberIdMovement', function() {
        // TODO: update the code to test PutFleetsFleetIdMembersMemberIdMovement
        expect(instance).to.be.a(EveSwaggerInterface.PutFleetsFleetIdMembersMemberIdMovement);
      });
