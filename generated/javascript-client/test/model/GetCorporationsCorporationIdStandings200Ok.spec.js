...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetCorporationsCorporationIdStandings200Ok', function() {
      beforeEach(function() {
        instance = new EveSwaggerInterface.GetCorporationsCorporationIdStandings200Ok();
      });

      it('should create an instance of GetCorporationsCorporationIdStandings200Ok', function() {
        // TODO: update the code to test GetCorporationsCorporationIdStandings200Ok
        expect(instance).to.be.a(EveSwaggerInterface.GetCorporationsCorporationIdStandings200Ok);
      });
