...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetUniverseStargatesStargateIdPosition', function() {
      beforeEach(function() {
        instance = new EveSwaggerInterface.GetUniverseStargatesStargateIdPosition();
      });

      it('should create an instance of GetUniverseStargatesStargateIdPosition', function() {
        // TODO: update the code to test GetUniverseStargatesStargateIdPosition
        expect(instance).to.be.a(EveSwaggerInterface.GetUniverseStargatesStargateIdPosition);
      });
